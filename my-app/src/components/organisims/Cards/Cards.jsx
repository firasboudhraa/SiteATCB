  ...
  const cardData = [
    {
      ...
      description: "Nestled along the tranquil shores of a pristine lake, Lakeview Lakeside offers an idyllic escape into nature's embrace. This exquisite property combines rustic charm with modern luxury, featuring a spacious, elegantly designed home with panoramic lake views.",
      price: "$4,750,000",
    ...
    },
    {
      ...
      description: "Vista Paradiso is an epitome of modern luxury, nestled against a backdrop of a breathtaking lake and verdant scenery.",
      price: "$4,500,000",
    ...
    },
    {
      ...
      description: "Skyline Oasis is a beacon of modern urban luxury, located in the heart of the city.",
      price: "$5,200,000",
        ...
        <article key={index} className={styles.card}>
          ...
          <div className={styles.card__content}>
            ...
            <div className={styles.card__bottom}>
              ...
              <button
                className={`${styles.card__btn} ${likedCards[index] ? styles['card__btn--like'] : ''}`}
